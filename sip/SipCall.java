...
public class SipCall extends AsyncTask<Object, Object, Object> {
    ...
    protected Object doInBackground(Object... params) {
        ...
        try {
            SipURI from = SipStackAndroid.addressFactory.createSipURI(_gs.getSipUserName(),
                    _gs.getLocalEndpoint());
...
*/
            ...
            SipURI contactURI = SipStackAndroid.getInstance().addressFactory.createSipURI(_gs.getSipUserName(), _gs.getLocalIp());
            contactURI.setPort(SipStackAndroid.getInstance().sipProvider.getListeningPoint(_gs.getTransport())
                    .getPort());
            ...
            String sdpData= "v=0\r\n"
                    ...
                    + " IN IP4 " + _gs.getLocalIp() +"\r\n" + "s=mysession session\r\n"
                    + "p=+46 8 52018010\r\n" + "c=IN IP4 " + _gs.getLocalIp()+"\r\n"
